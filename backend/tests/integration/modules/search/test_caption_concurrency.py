...
def test_dismissal_survives_an_unrelated_writer_after_caption_lookup(tmp_path):
    ...
    try:
        ...
        with Session(engine) as observer:
            ...
            assert observer.get(Model, other_id).description == "Other write committed"
    finally:
        engine.dispose()


def test_writer_reservation_preserves_an_existing_transaction(tmp_path):
